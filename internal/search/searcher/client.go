...
func Search(ctx context.Context, searcherURLs *endpoint.Map, repo api.RepoName, commit api.CommitID, p *search.TextPatternInfo, fetchTimeout time.Duration, zoektAddrs string) (matches []*protocol.FileMatch, limitHit bool, err error) {
	if MockSearch != nil {
