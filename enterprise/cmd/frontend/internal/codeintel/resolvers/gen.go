...
//go:generate $PWD/.bin/go-mockgen -f github.com/sourcegraph/sourcegraph/enterprise/cmd/frontend/internal/codeintel/resolvers -i DBStore -i LSIFStore -i GitserverClient -i IndexEnqueuer -o mock_iface_test.go
